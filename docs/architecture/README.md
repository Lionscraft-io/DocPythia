...
This directory contains architecture documentation for significant system changes, cross-cutting concerns, and design patterns used in the NearDocsAI platform.
...
Describes the architecture for transforming NearDocsAI into a multi-customer configurable platform with per-instance deployments.
