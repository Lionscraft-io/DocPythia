...
const sections: Prisma.DocumentationSectionCreateInput[] = [
  {
    ...
    content: "This is example documentation seed data. In production, documentation should be imported from your Git repository using the RAG system configured in config/instance.json. Replace this with your actual documentation content.",
    level: 1,
    type: null,
    orderIndex: 0,
  },
  ...
  // Example Section
  {
    ...
    content: "Replace this section with your project's getting started guide. Documentation is automatically synced from the Git repository configured in config/instance.json.",
    level: 2,
    type: null,
    orderIndex: 1,
  },
  {
    ...
    content: "This is example seed data. Your actual documentation should be synced from the Git repository specified in config/instance.json using the RAG documentation retrieval system.",
    type: "info",
    orderIndex: 2,
  },
];
