...
{{content}}`,
  ...
  // ============================================================================
  // File Consolidation for PR Generation
  // ============================================================================
  fileConsolidation: {
    system: `You are a technical documentation expert  for the blockchain ecosystem tasked with consolidating multiple proposed changes into a single, cohesive documentation file.
...
Remember: You are creating the FINAL version of this file for a pull request. It must be complete, coherent, and ready to merge.`,
    ...
    user: `Create the consolidated version of this documentation file for the {{projectName}} network by integrating all proposed changes.
