...
describe('Session Management', () => {
  ...
  describe('COOKIE_NAMES', () => {
    it('should export correct cookie names', () => {
      expect(COOKIE_NAMES.accessToken).toBe('docsai_access_token');
      expect(COOKIE_NAMES.refreshToken).toBe('docsai_refresh_token');
      expect(COOKIE_NAMES.csrfToken).toBe('docsai_csrf_token');
    });
  });
