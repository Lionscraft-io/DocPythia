...
export function flattenConversations(conversations: ConversationData[] | undefined): FlattenedUpdate[] {
  ...
  for (const conv of conversations) {
    ...
    for (const proposal of conv.proposals || []) {
      flattened.push({
        ...
        diffBefore: null,
        diffAfter: proposal.edited_text || proposal.suggested_text || proposal.editedText || proposal.suggestedText,
