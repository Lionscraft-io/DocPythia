...
export function NodeTypeCard({ title, description, icon: Icon, href, iconColor = "text-primary" }: NodeTypeCardProps) {
  return (
    <Card className="hover-elevate transition-all">
      ...
      <CardContent>
        <Link href={href}>
          <Button variant="ghost" className="group" data-testid={`button-view-${title.toLowerCase()}`}>
            View Documentation
